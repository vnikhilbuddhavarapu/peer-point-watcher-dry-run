/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 45f2933c487e270ad9e4155bd4684740)
...
interface __BaseEnv_Env {
	...
	MOCK_PAGE_BASE_URL: "https://peer-point-mock-pages.peer-point-user-group.workers.dev";
	WATCH_PATH: "/market-cycle";
	CITY: "Montreal";
	CARD: "watcher";
	ENVIRONMENT: "starter";
	WATCHER_AGENT: DurableObjectNamespace<import("./src/server").WatcherAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "WatcherAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "MOCK_PAGE_BASE_URL" | "WATCH_PATH" | "CITY" | "CARD" | "ENVIRONMENT">> {}
}
